...
export function toJS(source: any, detectCycles: boolean, __alreadySeen: [any, any][]): void; // internal overload
export function toJS(source: any, detectCycles: boolean = true, __alreadySeen: [any, any][] = []) {
